...
class StepsParser extends AbstractBlockContinueParser implements BlockContinueParserWithInlinesInterface
{
    /** @psalm-readonly */
    private Steps $block;
    ...
    {
        $this->block = new Steps();
        $this->strings = new ArrayCollection();
    }

    public function getBlock(): Steps
    {
        return $this->block;
    }
